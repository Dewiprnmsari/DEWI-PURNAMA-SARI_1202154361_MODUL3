package com.example.android.dewipurnamasari_1202154361_modul3;
...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        //get attribute yang di kirim dari activity sebelumnya
    ...
    public void tambahAir(View view) {
        if (jumlah < 5) {
            ...
            Toast toast = Toast.makeText(context, "Air sudah penuh", Toast.LENGTH_SHORT);
            toast.show();
        }
        jumlahAir();
    }
    ...
    public void kurangiAir(View view) {
        if (jumlah > 0) {
            ...
            Context context = getApplicationContext();
            Toast toast = Toast.makeText(context, "Air Sedikit", Toast.LENGTH_SHORT);
            toast.show();
        }
        jumlahAir();
    }
